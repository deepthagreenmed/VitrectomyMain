    ...
    ui(new Ui::settingswindow)
{
    ...
    QTimer *timergpio2=new QTimer;
    connect(timergpio2,&QTimer::timeout,this,&settingswindow::comboBoxTL);
    connect(timergpio2,&QTimer::timeout,this,&settingswindow::comboBoxBL);
    connect(timergpio2,&QTimer::timeout,this,&settingswindow::comboBoxBR);
    connect(timergpio2,&QTimer::timeout,this,&settingswindow::comboBoxTR);
    timergpio2->start(100);
