...
void MainWindow::on_clicked(const QString& digit)
{
  ...
  if(ui->label_vitpreset->focusWidget()) {
      ...
      if(madtype=="Midlabs")
      {
          updateLabelValue(ui->label_vitpreset, dig, value, 8040);
      }
      if(madtype=="Alcon")
      {
          updateLabelValue(ui->label_vitpreset, dig, value, 7500);
      }
...
{
    timerscreen->stop();
if((ui->comboBox_surgeonname->currentIndex())>=-1 && (ui->comboBox_surgeonname->currentIndex())<20)
{
